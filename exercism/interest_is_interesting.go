...
func main() {
	...
	fmt.Println(Interest(1000.0)) // => 0.5

	//interes := InterestRate(200.75)
	fmt.Println(float64(AnnualBalanceUpdate(200.75)))
...
func Interest(balance float64) float64 {
	//fmt.Printf("\n\nBalance: %f and %f = %f", balance, InterestRate(balance), balance*float64(InterestRate(balance)))
